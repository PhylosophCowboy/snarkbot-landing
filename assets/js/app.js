...
// Global variables
let conversationTimer = 20 * 60; // 20 minutes in seconds
let timerInterval;
...
function handleAIResponse(userMessage) {
    // This is a placeholder for the AI Tutor API integration
    // For now, we'll use simple response logic
    
    let response = generateSnarkyResponse(userMessage);
    ...
    if (savedData) {
        try {
            ...
            if (sessionAge < 24 * 60 * 60 * 1000) {
                ...
                conversationTimer = sessionData.conversationTimer || 20 * 60;
